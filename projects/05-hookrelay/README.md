...
- `apps/web` Next.js dashboard for creating endpoints, submitting events, searching paginated delivery attempts by server-side filters, replaying attempts, and viewing the delivery contract.
