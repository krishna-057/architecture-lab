...
| Worker process | Sends signed outbound HTTP requests, classifies receiver failures, records responses, schedules retries, marks dead-letter failures, and dispatches best-effort webhook alert notifications. |
